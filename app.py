...
def get_video_info(url):
    ydl_opts = {
        ...
        "merge_output_format": "mp4",          # Merge output as MP4 (for info only)
...
def index():
    ...
    <body>
        <div class="container">
            ...
            {% if video_info and url %}
            <div class="downloads">
                <h2>Video Found</h2>
                <div class="download-item">
                    <span>{{ video_info.get('title', 'Video') }}</span>
                    <div class="download-buttons">
                        <a href="{{ url_for('download_video', url=url, format='video') }}" class="download-button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                            Download Video (MP4)
                        </a>
                        <a href="{{ url_for('download_video', url=url, format='audio') }}" class="download-button" style="background-color: #7249d1;">
    ...
    ''', result=result, error=error, video_info=video_info, url=video_url)
